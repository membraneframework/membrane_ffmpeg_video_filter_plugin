defmodule TextOverlay.TextOverlayTest do
  ...
  defp make_pipeline(in_path, out_path, text_overlay_args) do
  end
  ...
  @tag :tmp_dir
  test "apply text stream on part of the video", %{tmp_dir: tmp_dir} do
    {in_path, out_path, ref_path} =
      Helpers.prepare_paths("4s_2fps.h264", "ref-stream.yuv", tmp_dir)
